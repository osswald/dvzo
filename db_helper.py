...
setup_helper.create_station()
setup_helper.create_function()
setup_helper.create_train_timetable_template()
...
day_planning_2 = setup_helper.get_day_planning(date_str="2021-05-22", label="Whatever Planning")

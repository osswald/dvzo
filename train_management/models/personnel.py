...
class Personnel(AbstractDvzoModel):
    ...
    status = models.CharField(_("personnel.status"), max_length=80, choices=PersonnelStatus.choices)
    mobile_phone_public = models.CharField(
        _("personnel.personnel_mobile_public"),
        max_length=80,
        choices=PersonnelMobilePublic.choices,
        default=PersonnelMobilePublic.UNKNOWN,
    )

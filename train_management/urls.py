...
urlpatterns = [
    ...
    path(
        "dayplanning/detail/<int:pk>/recipients",
        views.DayPlanningRecipientView.as_view(),
    ...
    path(
        "dayplanning/text/delete/<int:pk>/", views.DayPlanningTextDeleteView.as_view(), name="day-planning-text-delete"
    ),
    path(
        "dayplanning/<int:pk>/briefing/",
        views.BriefingPrintView.as_view(template_name="pdf/briefing.html"),
        name="briefing-pdf",
    ),
    path("bulletin/", views.BulletinPrintView.as_view(template_name="pdf/bulletin.html"), name="bulletin-pdf"),
    path(
        "bulletin-html/",
        views.DayPlanningBulletinView.as_view(template_name="pdf/bulletin_html.html"),
        name="bulletin-html",
    ),
    ...
    path(
        "dayplanning/train/reservation/add/<int:pk>/", views.ReservationCreateView.as_view(), name="reservation-create"
    ),
    path("dayplanning/train/reservation/<int:pk>/", views.ReservationUpdateView.as_view(), name="reservation-update"),
    path("dayplanning/train/reservation/", views.ReservationListView.as_view(), name="reservation-list"),
    path(
        "dayplanning/train/reservation/delete/<int:pk>/",
        views.ReservationDeleteView.as_view(),
        name="reservation-delete",
    ),
    path(
        "dayplanning/train/timetable/add/<int:pk>/",
        views.TrainTimetableCreateView.as_view(),
        name="train-timetable-create",
    ),
    path(
        "dayplanning/train/timetable/<int:pk>/", views.TrainTimetableUpdateView.as_view(), name="train-timetable-update"
    ),
    path(
        "dayplanning/train/timetable/delete/<int:pk>/",
        views.TrainTimetableDeleteView.as_view(),
        name="train-timetable-delete",
    ),
    path(
        "traintimetabletemplate/", views.TrainTimetableTemplateListView.as_view(), name="train-timetable-template-list"
    ),
    path(
        "traintimetabletemplate/choose/",
        views.ChooseTimetableTemplatesView.as_view(),
        name="train-timetable-template-choose",
    ),
    path(
        "traintimetabletemplate/use/",
        views.CreateTimetablesFromTemplateView.as_view(),
        name="train-timetable-template-use",
    ),
    path(
        "traintimetabletemplate/<int:pk>/",
        views.TrainTimetableTemplateUpdateView.as_view(),
        name="train-timetable-template-detail",
    ),
    path(
        "traintimetabletemplate/add/",
        views.TrainTimetableTemplateCreateView.as_view(),
        name="train-timetable-template-create",
    ),
    path(
        "traintimetabletemplate/<int:pk>/delete/",
        views.TrainTimetableTemplateDeleteView.as_view(),
        name="train-timetable-template-delete",
    ),
    path("edit-train-functions/<int:train_id>", views.EditTrainFunctions.as_view(), name="edit-train-functions"),
    path(
        "edit-dayplanning-functions/<int:dayplanning_id>",
        views.EditDayPlanningFunctions.as_view(),
        name="edit-dayplanning-functions",
    ),
    path("traincomposition/add/<int:pk>/", views.TrainCompositionCreateView.as_view(), name="train-composition-create"),
    ...
    path(
        "availability/engine/<int:pk>/", views.AvailabilityEngineUpdateView.as_view(), name="availability-engine-detail"
    ),
    path(
        "availability/carriage/<int:pk>/",
        views.AvailabilityCarriageUpdateView.as_view(),
        name="availability-carriage-detail",
    ),
    path(
        "availability/engine/add/<int:pk>",
        views.AvailabilityEngineCreateView.as_view(),
        name="availability-engine-create",
    ),
    path(
        "availability/carriage/add/<int:pk>",
        views.AvailabilityCarriageCreateView.as_view(),
        name="availability-carriage-create",
    ),
    ...
    path(
        "reservation-calendar/<int:pk>", views.ReservationCalendarTrains.as_view(), name="reservation-calendar-trains"
    ),
    ...
    path(
        "personnel-category/<int:pk>/delete/",
        views.PersonnelCategoryDeleteView.as_view(),

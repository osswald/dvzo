...
class ReservationCalendarTrains(DvzoView):
    ...
    def get(self, request, pk, **kwargs):
        ...
        return render(
            self.request,
            "train_management/reservation_calendar_trains.html",
...
class ReservationCalendarData(DvzoView):
    ...
    def get(self, request):
        dayplannings_out = []
        color = "grey"
        dayplannings = DayPlanning.objects.exclude(
            Q(booking_status=DayPlanning.DayPlanningBookingStatus.CANCELLED_CUSTOMER)
